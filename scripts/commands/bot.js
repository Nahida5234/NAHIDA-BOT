...
  var tl = ["আই লাভ ইউ 🫣🫣" , "শুনবো না😼 তুমি আমাকে প্রেম করাই দাও নি🥺 পচা তুমি🥺 " , "jan i love you 😘🫣" , "এত কাছেও এসো না,প্রেম এ পরে যাবো তো 🙈" , "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈💋 " , "jan ummma 💋", "হা বলো😒,কি করতে পারি😐😑?" , "এতো ডাকছিস কোনো?গালি শুনবি নাকি? 🤬","ছেলে হলে তিশা ম্যাম এর সাথে প্রেম করো🙈??. " ,  "আরে Bolo আমার জান ,কেমন আসো?😚 " , "Bot বলে অসম্মান করচ্ছিছ,😰😿" , "কাছে এসে কিস দেই 💋💋" , "চুপ থাক ,নাই তো তোর দাত ভেগে দিবো কিন্তু" , "Bot না , জানু বল জানু 😘 " , "আমার তিশা জানু এর সাথে ব্যাস্ত আসি😋" , "কাছে এসে কিস দেই জান 💋😘" , "আমাকে ডাকলে ,আমি কিন্তূ কিস করে দেবো😘 " , "বট বট না করে তিশা ম্যাম এর চিপায় আসো 😉" , "হা জানু , এইদিক এ আসো কিস দেই🤭 😘" , "দূরে যা, তোর কোনো কাজ নাই, শুধু bot bot করিস  😉😋🤣" , "তোর কথা তোর বাড়ি কেউ শুনে না ,তো আমি কোনো শুনবো ?🤔😂 " , "আমাকে ডেকো না,আমি ব্যাস্ত আসি" , "কি হলো ,মিস টিস করচ্ছিস নাকি🤣" , "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏" , "কালকে দেখা করিস তো একটু 😈" , "হা বলো, শুনছি আমি 😏" , "আর কত বার ডাকবি ,শুনছি তো" , "Mem তিশা কে Ummmmha দে 😒" , "বলো কি করতে পারি তোমার জন্য" , "আমি তো অন্ধ কিছু দেখি না🐸 😎" , "Bot না জানু,বল 😌" , "বলো জানু 🌚" , "তোর কি চোখে পড়ে না আমি তিশা ম্যাম এর সাথে ব্যাস্ত আসি😒"  , "হুম বলো" , "amr Jan lagbe,Tumi ki single aso?", "জান তোমারে আমার অনেক ভালো লাগে 💋" , " I love you baby chele hole chipay aso👩‍❤️‍👨"];
  var rand = tl[Math.floor(Math.random() * tl.length)]
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("_আগে brush করে আই তারপর কিস দিস_!😼😒", threadID);
   };
    if ((event.body.toLowerCase() =="🙋‍♂️" ) || (event.body.toLowerCase() == "👍🏻")) {
     return api.sendMessage("_ Tisha mam,Group এ হাত মারতে নিষেধ করেছে ", threadID);
   };
...
     return api.sendMessage("Tisha Queen\nhttps://www.facebook.com/share/1GcjApRKrt/", threadID);
   };
...
   };
   if ((event.body.toLowerCase() == "তিশা") || (event.body.toLowerCase() == "Tisha") || (event.body.toLowerCase() == "তিশা") || (event.body.toLowerCase() == "Tisha")) {
     return api.sendMessage( "আসসালামুয়ালাইকুম আমি তিশা এর Bot বলতে আছি? তিশা mam বিজি আছে? যা বলার আমাকে বলেন,🥰? (আবে ওই সয়তান তুই কি ওজু করছো তিশা ম্যাম নাম লও? 😘",threadID);
   };
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "creator")) {
     return api.sendMessage("‎[Bot owner :亗 mem Tisha 亗 \n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Picchi in English . Facebook https://www.facebook.com/share/1GcjApRKrt/ \n whatsApp :-দিমু নাহ ", threadID);
   };
   if ((event.body.toLowerCase() == "bot কে বানাইছে") || (event.body.toLowerCase() == "tumke banaise ke?")) {
     return
       api.sendMessage("mam tisha is My Creator🥰. He loves me & Edit Me Daily. He is a good boy 😊", threadID);
   };
...
     return api.sendMessage("নাৃঁ,আৃঁমিৃঁ তোৃঁ রোৃঁবৃঁটৃঁ আৃঁমিৃঁ love কৃঁরৃঁমুৃঁ কিৃঁভাৃঁবেৃঁ,ছে্ঁলে্ঁ হঁলেৃঁ তুৃঁমিৃঁ আৃঁমাৃঁরৃঁ ম্যা্ঁ tisha কেৃঁ love কৃঁরোৃঁ🥰", threadID);
   };
...
     return api.sendMessage("Nh ami চুপ থাকবো না.😼 তিশা ম্যম আমারে কথা বলতে বলছে🤭", threadID);
   };
...
     return api.sendMessage("️ আমি দিবো না,😒তিশা ম্যাক কে বলো দিতে🐸", threadID);
   };
...
     return api.sendMessage("️ তুমি নিজেই বানাই নাও 😒😼,তিশা অনেক ব্যস্ত্ এখন", threadID);
   };
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
...
     return api.sendMessage("️ আবে ওই শালা 😡 আমার তিশা ম্যাম কে i love you বল🥰", threadID);
   };
...
     return api.sendMessage("আসালামু ওয়ালাইকুম আমি তিশা এর বট বলতে আছি আমি কলে আসতে পারি না", threadID);
   };
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("এৃঁতোৃঁ ভাৃঁলোৃঁবাৃঁসাৃঁ কৃঁইৃঁ পাৃঁওৃঁ আৃঁমাৃঁরৃঁ ম্যাৃঁমৃঁ তিৃঁশাৃঁ কেৃঁ এৃঁকৃঁটুৃঁ দেৃঁওৃঁ🥰", threadID);
   };
...
   };
   if ((event.body.toLowerCase() == "আমি তিশা") || (event.body.toLowerCase() == "Ami nayem")) {
