...
  var tl = ["আই লাভ ইউ 🫣🫣" , "শুনবো না😼 তুমি আমাকে প্রেম করাই দাও নি🥺 পচা তুমি🥺 " , "jan i love you 😘🫣" , "এত কাছেও এসো না,প্রেম এ পরে যাবো তো 🙈" , "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈💋 " , "jan ummma 💋", "হা বলো😒,কি করতে পারি😐😑?" , "এতো ডাকছিস কোনো?গালি শুনবি নাকি? 🤬","ছেলে হলে নাদিয়া বসের সাথে প্রেম করো🙈??. " ,  "আরে Bolo আমার জান ,কেমন আসো?😚 " , "Bot বলে অসম্মান করচ্ছিছ,😰😿" , "কাছে এসে কিস দেই 💋💋" , "চুপ থাক ,নাই তো তোর দাত ভেগে দিবো কিন্তু" , "Bot না , জানু বল জানু 😘 " , "আমার নাদিয়া জানু এর সাথে ব্যাস্ত আসি😋" , "কাছে এসে কিস দেই জান 💋😘" , "আমাকে ডাকলে ,আমি কিন্তূ কিস করে দেবো😘 " , "বট বট না করে নাদিয়া বস এর চিপায় আসো 😉" , "হা জানু , এইদিক এ আসো কিস দেই🤭 😘" , "দূরে যা, তোর কোনো কাজ নাই, শুধু bot bot করিস  😉😋🤣" , "তোর কথা তোর বাড়ি কেউ শুনে না ,তো আমি কোনো শুনবো ?🤔😂 " , "আমাকে ডেকো না,আমি ব্যাস্ত আসি" , "কি হলো ,মিস টিস করচ্ছিস নাকি🤣" , "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏" , "কালকে দেখা করিস তো একটু 😈" , "হা বলো, শুনছি আমি 😏" , "আর কত বার ডাকবি ,শুনছি তো" , "BOSS নাদিয়া কে Ummmmha দে 😒" , "বলো কি করতে পারি তোমার জন্য" , "আমি তো অন্ধ কিছু দেখি না🐸 😎" , "Bot না জানু,বল 😌" , "বলো জানু 🌚" , "তোর কি চোখে পড়ে না আমি নাদিয়া BOSS এর সাথে ব্যাস্ত আসি😒"  , "হুম বলো" , "amr Jan lagbe,Tumi ki single aso?", "জান তোমারে আমার অনেক ভালো লাগে 💋" , " I love you baby meye hole chipay aso👩‍❤️‍👨"];
  var rand = tl[Math.floor(Math.random() * tl.length)]
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("_আগে brush করে আই তারপর কিস দিস_!😼😒", threadID);
   };
    if ((event.body.toLowerCase() =="🙋‍♂️" ) || (event.body.toLowerCase() == "👍🏻")) {
     return api.sendMessage("_  নাদিয়া বস ,Group এ হাত মারতে নিষেধ করেছে ", threadID);
   };
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("Hello, Hi, Bye bye. এটা সারা কি কিছু বলতে প্যারিস না তুই?😒", threadID);
   };
   if ((event.body.toLowerCase() == "Bot boss") || (event.body.toLowerCase() == "তিশা কে")) {
     return api.sendMessage("Tisha n\https://www.facebook.com/share/1GcjApRKrt/, threadID);
   };
...
   };
   if ((event.body.toLowerCase() == "তিশা") || (event.body.toLowerCase() == "নাদিয়া") || (event.body.toLowerCase() == "Tisha") || (event.body.toLowerCase() == "Nahida")) {
     return api.sendMessage( "আসসালামুয়ালাইকুম আমি নাদিয়ার Bot বলতে আছি? নাদিয়া BOSS বিজি আছে? যা বলার আমাকে বলেন,🥰? (আবে ওই কুত্তা তুই ওজু করছো নাদিয়া বসের নাম লও? 😘",threadID);
   };
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "creator")) {
     return api.sendMessage("‎[Bot owner :亗 BOSS TISHA 亗 \n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Picchi in English . Facebook id:- https://www.facebook.com/share/1GcjApRKrt/\n whatsApp :-দিমু নাহ ", threadID);
   };
   if ((event.body.toLowerCase() == "bot কে বানাইছে") || (event.body.toLowerCase() == "tumke banaise ke?")) {
     return api.sendMessage("Boss Tisha is My Creator🥰. He loves me & Edit Me Daily. He is a good boy 😊", threadID);
   };
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "botka admin kon ha")) {
     return api.sendMessage("He is Tisha  Boss\n He Gives his name,_You're nex't cru'sh everywhare", threadID);
   };
   if ((event.body.toLowerCase() == "bot love you") || (event.body.toLowerCase() == "Bot love you")) {
     return api.sendMessage("নাৃঁ,আৃঁমিৃঁ তোৃঁ রোৃঁবৃঁটৃঁ আৃঁমিৃঁ love কৃঁরৃঁমুৃঁ কিৃঁভাৃঁবেৃঁ,ছে্ঁলে্ঁ হঁলেৃঁ তুৃঁমিৃঁ আৃঁমাৃঁরৃঁ বৃঁসৃঁ Nahida কেৃঁ love কৃঁরোৃঁ🥰", threadID);
   };
...
     return api.sendMessage("Nh ami চুপ থাকবো না.😼 নাদিয়া বস আমারে কথা বলতে বলছে🤭", threadID);
   };
...
     return api.sendMessage("️ আমি দিবো না,😒নাদিয়া বস কে বলো দিতে🐸", threadID);
   };
...
     return api.sendMessage("️️️ও ভাই গুরুপে আগুন লাগছে আমার ভয় লাগে, আমার নাদিয়া জানু কে কেউ ফোন দেও😛", threadID);
   };
...
     return api.sendMessage("️ তুমি নিজেই বানাই নাও 😒😼নাদিয়া অনেক ব্যস্ত্ এখন", threadID);
   };
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
...
     return api.sendMessage("️ আবে ওই সালা 😡 আমার নাদিয়া বস কে i love you বল🥰", threadID);
   };
...
     return api.sendMessage("আসালামু ওয়ালাইকুম আমি নাদিয়ার  বট বলতে আছি আমি কলে আসতে পারি না", threadID);
   };
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("এৃঁতোৃঁ ভাৃঁলোৃঁবাৃঁসাৃঁ কৃঁইৃঁ পাৃঁওৃঁ আৃঁমাৃঁরৃঁ বৃঁসৃ্ঁ Tisha কেৃঁ এৃঁকৃঁটুৃঁ দেৃঁওৃঁ🥰", threadID);
   };
...
   };
   if ((event.body.toLowerCase() == "আমি তিশা") || (event.body.toLowerCase() == "আমি নাদিয়া")) {
