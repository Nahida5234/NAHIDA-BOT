...
a("....///-- আমি আমার তিশা ম্যাম পক্ষো থেকে বলতাছি, ☺️💝🌺...//");
setTimeout(() => {a({body: "শুনো প্রিয় খুব ভালো বাসি তোমায় 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "তোমার সাথে একবার কথা না বল্লে তিশা ম্যাম এর মনটা কেমন জানি করে☺️" + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "জান তুমি এত সুন্দর কেন তিশা যে তোমায় না দেখে থাকতে পারি না😻🥰💚 " + " " + name, mentions: arraytag})}, 17000);
